...
Используется как инструмент при разработке [**lava-orb**](http://192.168.1.130:3000/androman/lava-orb) — оттачивает параметры жидкости, которые потом копируются в основную библиотеку.
...
- 🖼️ **Backgrounds** — Ocean, Space, Abstract (те же, что и в [shared-backgrounds](http://192.168.1.130:3000/androman/shared-backgrounds))
...
git clone http://192.168.1.130:3000/androman/liquid-orb-editor
...
- [**lava-orb**](http://192.168.1.130:3000/androman/lava-orb) — основная библиотека, использует найденные здесь параметры
- [**fire-particle-editor**](http://192.168.1.130:3000/androman/fire-particle-editor) — аналогичный редактор для пламени
- [**shared-backgrounds**](http://192.168.1.130:3000/androman/shared-backgrounds) — WebGL2-фоны (Ocean/Space/Abstract отсюда вытащены туда)
...
Live sandbox for tweaking liquid simulation inside a sphere — waves, gravity, splashes, viscosity, tilt inertia. Canvas 2D and WebGL 2 renderers. Used during the development of [**lava-orb**](http://192.168.1.130:3000/androman/lava-orb) to tune the fluid parameters that are later ported to the main library.
